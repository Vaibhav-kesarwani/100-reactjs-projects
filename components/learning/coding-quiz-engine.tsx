...
export default function CodingQuizEngine({
  title,
  moduleId,
  questions,
  scoringRule,
  feedbackRule,
}: CodingQuizEngineProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add coding quiz content to start practicing.
          </CardDescription>
        </CardHeader>
      </Card>
    );
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {passed
              ? "Solid run through the code review."
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <pre className="rounded-lg border border-border bg-muted/40 p-4 text-sm text-foreground/90 overflow-x-auto">
